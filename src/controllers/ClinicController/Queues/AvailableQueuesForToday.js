...
const AvailableQueuesForToday = () => {
  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get('http://localhost:5015/api/Clinic/availableQueuesForToday', {
        params: {
          firstName,
          lastName,
        },
  ...
  return (
    <div style={{ marginTop: '2rem', padding: '1rem', border: '1px solid #ccc' }}>
      <h3>📅 זמינות תורים לרופא להיום</h3>
...
export default AvailableQueuesForToday;
